<section class="page-header fade-up">
    <div class="container">
        <div class="section-header">
            <span class="section-tag">Dedicated Portal</span>
            <h1 class="section-title">EPF & ESIC <br><span>Services</span></h1>
            <p class="section-desc">Comprehensive compliance and support solutions for employers and employees. Manage claims, registrations, and regulatory audits with ease.</p>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="portal-layout">
            ...
            <aside class="portal-sidebar">
                <h4 class="sidebar-title">Menu Navigation</h4>
                <ul class="sidebar-nav">
                    <li><a class="tab-link active" onclick="switchTab('what-is', this)">What is EPF & ESIC</a></li>
            ...
            <div class="portal-content">
                ...
                <!-- Tab 1: What is it -->
                <div id="what-is" class="tab-pane active">
                    <h2 class="section-title" style="font-size: 28px; margin-bottom: 24px;">What is EPF & ESIC</h2>
                    
                    <div class="info-block">
                        <h3>1. What is EPF?</h3>
                        <p>EPF means Employees' Provident Fund. It is a retirement savings scheme for employees. Both employer and employee contribute every month. Employees can claim PF amount, pension benefits, advances, and death benefits as per EPFO rules.</p>
                    </div>

                    <div class="info-block" style="border-left-color: #00D4FF;">
                        <h3>2. What is ESIC?</h3>
                        <p>ESIC means Employees' State Insurance Corporation. It provides medical and cash benefits to employees and their families in case of sickness, maternity, employment injury, disability, and death.</p>
                    </div>
                </div>

                <!-- Tab 2: Employee Services -->
                ...
                <div id="documents" class="tab-pane">
                    <h2 class="section-title" style="font-size: 28px; margin-bottom: 24px;">Required <span>Documents</span></h2>
                    
                    <div class="grid-2">
                        <div class="info-block">
                            <h3 style="font-size: 16px; margin-bottom: 12px; color: var(--color-accent);">For Employees (Claims & KYC)</h3>
                            <ul style="list-style: disc; margin-left: 20px; font-size: 14px; color: var(--color-text); line-height: 2;">
                                <li>Aadhaar Card (Linked to Mobile)</li>
                                <li>PAN Card</li>
                                <li>Active Bank Account / Cancelled Cheque</li>
                                <li>UAN Number & Password</li>
                                <li>Form 15G/15H (For tax saving on claims)</li>
                            </ul>
                        </div>
                        <div class="info-block" style="border-left-color: #00D4FF;">
                            <h3 style="font-size: 16px; margin-bottom: 12px; color: var(--color-accent);">For Employers (Registration)</h3>
                            <ul style="list-style: disc; margin-left: 20px; font-size: 14px; color: var(--color-text); line-height: 2;">
                                <li>Company PAN & Incorporation Docs</li>
                                <li>Directors/Partners Aadhaar & PAN</li>
