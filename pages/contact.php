...
<div class="contact-cards-container">
    <div class="contact-cards-grid">
        ...
        <div class="contact-info-card">
            ...
            <h3>Visit Us</h3>
            <p class="card-main-text" style="font-size: 13px; font-weight: 600; line-height: 1.4;">H.No.2-7-202, Beside Rice Millers Association Office, Opposite Khlabharathi Lane, Near Kims Degree Pg College, Karimnagar-505001</p>
        </div>
    </div>
</div>
